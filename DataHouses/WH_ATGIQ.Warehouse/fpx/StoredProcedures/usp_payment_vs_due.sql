...
BEGIN
    ...
    BEGIN
        ...
        SELECT
            ...
            CAST(Inv.InvoiceAmount AS DECIMAL(10,2)) AS Inv_InvoiceAmount,
            CAST(Inv.InvoiceCurrency AS VARCHAR(10)) AS Inv_InvoiceCurrency,
            CAST(Inv.InvoiceAmountSys AS DECIMAL(10,2)) AS Inv_InvoiceAmountSys,
            ...
            CAST(Inv.DueInDays AS DECIMAL(10,2)) AS Inv_DueInDays,
            CAST(Inv.DueInCategory AS VARCHAR(50)) AS Inv_DueInCategory,
            CAST(Inv.PaymentDate AS DATE) AS Inv_PaymentDate,
            CAST(Inv.CheckDays AS DECIMAL(10,2)) AS Inv_CheckDays,
            CAST(Inv.CheckDaysCategory AS VARCHAR(50)) AS Inv_CheckDaysCategory,
            CAST(Inv.ReceivingDelayDays AS DECIMAL(10,2)) AS Inv_ReceivingDelayDays,
            CAST(Inv.ReleaseDays AS DECIMAL(10,2)) AS Inv_ReleaseDays,
            ...
            CAST(Inv.AccountingDelayDays AS DECIMAL(10,2)) AS Inv_AccountingDelayDays,
            ...
            CAST(IID.QuantityInvoiced AS DECIMAL(10,2)) AS IID_QuantityInvoiced,
            CAST(IID.QuantityExpected AS DECIMAL(10,2)) AS IID_QuantityExpected,
            CAST(IID.QuantityDifference AS DECIMAL(10,2)) AS IID_QuantityDifference,
            CAST(IID.QuantityDifferenceAsAmount AS DECIMAL(10,2)) AS IID_QuantityDifferenceAsAmount,
            CAST(IID.AmountInvoiced AS DECIMAL(10,2)) AS IID_AmountInvoiced,
            CAST(IID.AmountExpected AS DECIMAL(10,2)) AS IID_AmountExpected,
            CAST(IID.AmountDifference AS DECIMAL(10,2)) AS IID_AmountDifference,
            CAST(IID.VATInvoiced AS DECIMAL(10,2)) AS IID_VATInvoiced,
            CAST(IID.VATExpected AS DECIMAL(10,2)) AS IID_VATExpected,
            CAST(IID.VATDifference AS DECIMAL(10,2)) AS IID_VATDifference,
