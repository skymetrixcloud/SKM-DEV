...
EXECUTE [WH_ATGIQ].[fpx].[usp_Load_Dim_Counterparty]
/*****Load Fact tables*******/
...
EXECUTE [WH_ATGIQ].[fpx].[usp_Load_Fact_BillbackInvoice]
EXECUTE [WH_ATGIQ].[fpx].[usp_Load_Fact_BillbackUnbilledEvents]
END